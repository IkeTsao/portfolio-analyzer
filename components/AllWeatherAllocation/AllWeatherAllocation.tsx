...
export function AllWeatherAllocation({ stats, loading }: AllWeatherAllocationProps) {
  ...
  return (
    <Paper p="md" withBorder>
      ...
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        • <strong>攻擊端 (50%)</strong>：對抗的是「錯失成長」的風險（獲取企業生產力回報）。<br />
        • <strong>防禦端 (50%)</strong>：對抗的是「貨幣貶值」與「極端動盪」的風險。
      </Text>

      {/* 攻擊端說明 */}
      <Title order={3} mt="xl" mb="md">攻擊端</Title>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        <strong>高股息在攻擊端的角色：防守型後衛</strong>
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        如果把您的攻擊端 (50%) 比喻成一支足球隊：
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7, paddingLeft: '1rem' }}>
        • <strong>前鋒 (Growth Stocks)</strong>：如 LITE、MU、TSMC。負責衝鋒陷陣，回報最高，但體力消耗（波動）也最大。<br />
      ...
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        <strong>針對 2026 年的建議變化</strong>
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        既然您提到 2026 年展望不錯，但金銀又創新高，您可以這樣思考高股息股票：
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7, paddingLeft: '1rem' }}>
        • <strong>當市場過熱時</strong>：將「前鋒（成長股）」的獲利轉向「後衛（高股息）」。這雖然還是在攻擊端內部移動，但已經實質降低了組合的波動率。<br />
      ...
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7, paddingLeft: '1rem' }}>
        • <strong>黃金</strong>：純粹的避險。波動相對穩定，主要隨利率與避險情緒起伏。<br />
        • <strong>大宗物資（如白銀）</strong>：避險 + 工業需求。<br />
        &nbsp;&nbsp;- 它具備避險屬性（跟隨黃金漲跌）。<br />
        &nbsp;&nbsp;- 它具備積極屬性（當經濟好、製造業強，銀的需求會暴增）
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
      ...
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        防禦端的安全性 = 現金 &gt; 黃金 &gt; 白銀/大宗物資
      </Text>

      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        <strong>為什麼目前的配置 高現金 + 高貴金屬取代債券？</strong>
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        您清空了短債中長債，這反映了您對目前債券作為防禦工具的不信任，這在當前環境下是有邏輯的：
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7, paddingLeft: '1rem' }}>
        • <strong>通膨風險 vs. 利率風險</strong>：債券最怕通膨。如果 2026 年通膨無法降至目標，利率維持高位，債券價格會持續受壓。此時，黃金與白銀比債券更能對抗通膨。<br />
        • <strong>現金的「期權價值」</strong>：您目前持有 {formatPercentage(stats.distributionByType.cash?.percentage || 0)} 的現金。雖然現金不生息（或利息低），但它沒有「價格跌損」的風險。在 2026 年展望看好的情況下，現金讓您保有隨時能加碼的權力。債券則會受利率波動影響，流動性雖好但有價差損失風險。
      </Text>

      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        <strong>債券風險化傾向</strong>
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        並非所有債券都是防禦端。在 50/50 框架下，我們會這樣劃分：
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7, paddingLeft: '1rem' }}>
        • <strong>防禦端債券</strong>：政府公債（如美國國庫券 SGOV, TLT）、高評級公司債。<br />
      ...
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7, paddingLeft: '1rem' }}>
        • 如果您認為 2026 年經濟會硬著陸（大衰退）且通膨消失：您應該把部分現金轉回長債。<br />
        • 如果您認為 2026 年通膨會揮之不去，但經濟展望不錯：您目前的配置（現金 + 黃金 + 白銀）其實比債券更適合作為防禦端，因為這三者對利率上升的抗性通常比中長債強。
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        簡單來說：在 50/50 策略裡，債券是「傳統防禦」，而您目前的 現金+貴金屬 是「強硬防禦」。
      </Text>
      ...
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        <strong>1. 定期再平衡 (Time-Based)</strong>
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        這是最省心的方法，適合不想頻繁看盤的投資者。
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7, paddingLeft: '1rem' }}>
        • <strong>頻率</strong>：每半年（6 月/12 月）或每年一次。<br />
        • <strong>做法</strong>：不管市場漲跌，時間到了就檢查比例，將「多出來的部分」賣掉，補進「比例縮水的部分」。<br />
        • <strong>優點</strong>：紀律簡單，避免過度頻繁交易造成的手續費損耗。
      </Text>

      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        <strong>2. 閥值再平衡 (Threshold-Based/Tolerance Bands) – 最推薦</strong>
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        這是「永久組合」與專業經理人最常使用的方法。您為 50% 的目標設定一個「偏離容忍度」。
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7, paddingLeft: '1rem' }}>
        • <strong>5% 準則</strong>：當資產比例偏離目標超過 5% 時觸及。<br />
        &nbsp;&nbsp;- 目標：50%<br />
        &nbsp;&nbsp;- 觸發點：當攻擊端漲到 55%，或跌到 45% 時，立刻進行調整。<br />
        • <strong>10% 準則（更寬鬆）</strong>：如果您持有的個股（如 MU, TSMC）波動極大，可設為 10% 偏離。也就是當攻擊端衝到 60% 時才賣出。
      </Text>

      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        <strong>3. ATH (歷史新高) 再平衡</strong>
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        現在正是您考慮再平衡的關鍵時刻，因為您的「雙端」都在創新高：
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7, paddingLeft: '1rem' }}>
        • <strong>當股票（攻擊端）創新高時</strong>：雖然 2026 展望好，但如果 TSMC 漲到讓你的攻擊端佔了總資產的 58%，依照紀律，你必須賣掉那 8% 的股票。這叫<strong>「收割獲利」</strong>。<br />
        • <strong>當金銀（防禦端）創新高時</strong>：如果金銀價格噴發，讓防禦端比例升高，你應該賣掉部分金銀，轉成現金。這叫<strong>「子彈入庫」</strong>。
      </Text>

      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        針對您現在有 {formatPercentage(stats.distributionByType.cash?.percentage || 0)} 的現金，這讓您的再平衡變得非常特別，我稱之為<strong>「不賣出的再平衡」</strong>：
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7, paddingLeft: '1rem' }}>
        1. <strong>向上再平衡（用現金）</strong>：如果您覺得 TSMC, MU 展望太好，不想賣掉它們，但目前的攻擊端只有 {formatPercentage(offensivePercentage)}（低於 50%），您不需要賣股票，而是動用那 {formatPercentage(stats.distributionByType.cash?.percentage || 0)} 的現金去買股票，直到攻擊端回到 50%。<br />
        2. <strong>內部再平衡（金銀切換）</strong>：既然金銀都破新高，目前不需要增加防禦端總量，而是做「內部優化」。若金銀比仍高，將部分黃金換成白銀，這也是一種再平衡。
      </Text>

      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        <strong>再平衡時的隱形成本</strong>
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        在執行再平衡時，請務必考量以下兩點，避免獲利被吃掉：
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7, paddingLeft: '1rem' }}>
        • <strong>稅務問題</strong>：在美股 (Etrade) 賣出獲利部位可能產生資本利得稅。若金額巨大，可以考慮用「新投入的現金」去買進落後的資產，而不是賣出領先的資產。<br />
        • <strong>滑價與手續費</strong>：不要為了 1% 的偏離就去調整。這就是為什麼建議設定 5% 的閥值，只有在大波動發生時，再平衡的收益才會大於交易成本。
      </Text>

      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        <strong>總結操作時間表</strong>
      </Text>
      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7, paddingLeft: '1rem' }}>
        • <strong>每季檢查</strong>：看一下比例。<br />
        • <strong>破 5% 動作</strong>：當 50/50 變成 55/45 或 45/55 時，開始調倉。<br />
        • <strong>大趨勢轉折</strong>：像您現在提到的 2026 展望與金銀新高，這就是一個<strong>「戰術性檢查點」</strong>。
      </Text>

      <Text mb="md" style={{ fontSize: '0.95rem', lineHeight: 1.7 }}>
        您現在的攻擊端是 {formatPercentage(offensivePercentage)}，防禦端是 {formatPercentage(defensivePercentage)}。如果按照 50/50 紀律，您現在的時機其實是：「利用現金，稍微補一點攻擊端（如 QQQ 或 MU），或者按兵不動等待股票大漲自動填滿那 5% 的缺口。」
      </Text>
    </Paper>
  );
}
